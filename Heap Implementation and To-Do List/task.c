...
{
	struct Task newTask;//Create a new task
	newTask.priority = priority; //Assign Priority to priority
	strcpy(newTask.name, name); //Assign name to name.
	return newTask; //return the NewTask
}
